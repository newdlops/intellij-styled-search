...
- Graph: function-scoped-assignment-closure-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23535**
- Usage changed from previous report: **867**
...
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 724 | 22 | 0 | 16036 | 4.31% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-closure-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-closure-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-closure-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-closure-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-closure-refresh/annotation_base_under_patterns.md`
