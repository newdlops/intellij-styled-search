...
- Graph: unpack-kwargs-callsite-remap-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
- Source refreshed rows: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/lsp_usage_results_refreshed.jsonl`
- Present rows: **25638**
...
- Overcount: **23262**
- Usage changed from previous report: **25**
- Annotation base check without structural margin: exact **3077/7696 = 39.98%**, under **118**, missed **15**, over **4486**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-unpack-kwargs-callsite-remap-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-unpack-kwargs-callsite-remap-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-unpack-kwargs-callsite-remap-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-unpack-kwargs-callsite-remap-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-unpack-kwargs-callsite-remap-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.30**
