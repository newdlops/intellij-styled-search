...
- Current graph usage refresh: changed=96, missing=0, errors=0
- Graph usage changed from cached baseline: 8001/10000

## Usage Signal

- Exact match: **6263/10000 = 62.6%**
- Within +/-1: 72.0%
- Within +/-5: 83.3%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| method | 4000 | 61.2 | 70.2 | 84.6 | 8.34 | 11.10 | 2.77 |
| class | 2000 | 75.8 | 92.6 | 98.0 | 0.87 | 6.96 | 6.10 |
| function | 2000 | 91.8 | 96.2 | 98.0 | 0.84 | 4.56 | 3.71 |
| constant | 2000 | 23.1 | 30.6 | 51.1 | 23.54 | 25.85 | 2.31 |
...
|---|---:|---:|
| match | 6263 | 62.6% |
| inlay_over_no_lsp_refs | 1548 | 15.5% |
...
| +400 | `zuzu/packages/company/registration_matters/graphql/types/__init__.py:102` | `date` | constant | 400 | 0 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-meta-suppressed/discrepancies.jsonl`
