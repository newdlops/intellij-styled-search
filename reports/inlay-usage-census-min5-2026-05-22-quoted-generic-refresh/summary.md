...
- Graph: quoted-generic-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23262**
- Usage changed from previous report: **6073**
- Annotation base check without structural margin: exact **3404/7696 = 44.23%**, under **124**, missed **28**, over **4140**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9556 | 37.27% |
| inlay_over_no_lsp_refs | 6283 | 24.51% |
| inlay_over_by_50plus | 5267 | 20.54% |
| exact | 2376 | 9.27% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-quoted-generic-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-quoted-generic-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-quoted-generic-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-quoted-generic-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-quoted-generic-refresh/annotation_base_under_patterns.md`
