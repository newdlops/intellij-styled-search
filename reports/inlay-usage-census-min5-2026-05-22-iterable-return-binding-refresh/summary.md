...
- Graph: iterable-return-binding-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23260**
- Usage changed from previous report: **4421**
- Annotation base check without structural margin: exact **2787/7688 = 36.25%**, under **127**, missed **30**, over **4744**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9546 | 37.23% |
| inlay_over_no_lsp_refs | 6285 | 24.51% |
| inlay_over_by_50plus | 5259 | 20.51% |
| exact | 2380 | 9.28% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-iterable-return-binding-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-iterable-return-binding-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-iterable-return-binding-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-iterable-return-binding-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-iterable-return-binding-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.62**
