...
- Graph: typeddict-list-alias-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23271**
- Usage changed from previous report: **4055**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-typeddict-list-alias-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-typeddict-list-alias-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-typeddict-list-alias-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-typeddict-list-alias-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-typeddict-list-alias-refresh/annotation_base_under_patterns.md`
