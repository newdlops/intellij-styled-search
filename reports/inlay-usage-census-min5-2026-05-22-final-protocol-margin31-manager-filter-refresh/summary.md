...
- Exact: **2402/25638 = 9.37%**
- Overcount: **23236**
- Usage changed from previous report: **9701**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-final-protocol-margin31-manager-filter-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-final-protocol-margin31-manager-filter-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-final-protocol-margin31-manager-filter-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-final-protocol-margin31-manager-filter-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-final-protocol-margin31-manager-filter-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **32.10**
