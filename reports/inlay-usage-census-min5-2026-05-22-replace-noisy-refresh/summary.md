...
- Overcount: **23245**
- Usage changed from previous report: **2378**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-replace-noisy-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-replace-noisy-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-replace-noisy-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-replace-noisy-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-replace-noisy-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.07**
