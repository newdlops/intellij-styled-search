...
- Graph: django-nonmodel-annotation-field-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2380/25640 = 9.28%**
- Overcount: **23260**
- Usage changed from previous report: **5321**
- Annotation base check without structural margin: exact **3389/7688 = 44.08%**, under **130**, missed **35**, over **4134**

## Per Kind

| kind | n | exact | under | missed | over | exact% |
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 1018 | 0 | 0 | 15764 | 6.07% |
...
| inlay_over_by_50plus | 5258 | 20.51% |
| exact | 2380 | 9.28% |
...
| 214 | `zuzu/packages/document/base.py:36` | `director_type` | constant | 221 | 7 | 222 |
...
| 205 | `zuzu/packages/company/meeting/types/meeting_plan_director_attendance_for_edit.py:23` | `director_type` | constant | 205 | 0 | 203 |
| 203 | `zuzu/db/models/agenda/base/shareholders_meeting_agenda_child_base.py:38` | `meeting` | method | 216 | 13 | 216 |
| 203 | `zuzu/db/models/incorporation_request/incorporation_request_director.py:25` | `director_type` | constant | 208 | 5 | 209 |
| 203 | `zuzu/packages/company/meeting/types/meeting_plan_agenda_director_change_for_edit.py:22` | `director_type` | constant | 203 | 0 | 216 |
| 203 | `zuzu/packages/corporate_registration/services/content_extract_service/corporate_registration_extraction_result_service.py:274` | `director_type` | constant | 207 | 4 | 220 |
| 202 | `zuzu/packages/company/graphql/types/company_list_item_type.py:48` | `director_type` | constant | 202 | 0 | 203 |

## Artifacts

- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-django-nonmodel-annotation-field-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-django-nonmodel-annotation-field-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-django-nonmodel-annotation-field-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-django-nonmodel-annotation-field-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-django-nonmodel-annotation-field-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.27**
