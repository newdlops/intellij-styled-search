...
- Graph: usage refreshed from `target/release/zoek-rs graph-symbol-query`, verified by file join rather than MCP graph
...
| function | 1149 | 298 | 0 | 0 | 851 | 25.94% |

## Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9160 | 35.67% |
| inlay_over_no_lsp_refs | 6622 | 25.79% |
| inlay_over_by_50plus | 6003 | 23.38% |
| inlay_over_by_1-5 | 2024 | 7.88% |
| exact | 1869 | 7.28% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-21-function-window-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-21-function-window-refresh/discrepancies.jsonl`
