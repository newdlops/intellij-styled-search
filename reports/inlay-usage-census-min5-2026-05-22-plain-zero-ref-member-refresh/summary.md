...
- Graph: plain-zero-ref-member-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2369/25640 = 9.24%**
- Overcount: **23271**
- Usage changed from previous report: **3939**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-plain-zero-ref-member-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-plain-zero-ref-member-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-plain-zero-ref-member-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-plain-zero-ref-member-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-plain-zero-ref-member-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.70**
