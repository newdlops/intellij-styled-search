...
|---:|---|---|---|---:|---:|---|
| -73 | `zuzu/packages/corporate_registration/auto_updater/types/branch_change.py:17` | `events` | constant | 15 | 88 | `BranchChangeEvent` |
...
| -14 | `zuzu/packages/company/payroll/year_end_tax_settlement/year_end_tax_settlement_public/types/yets_employee_upload_form_version2.py:9` | `public_link` | constant | 1 | 15 | `` |
...
| -12 | `zuzu/packages/stock/stock_service.py:114` | `unknown_issue_event` | constant | 6 | 18 | `Any` |
| -12 | `zuzu/packages/stock/stock_service.py:115` | `stock` | constant | 4 | 16 | `Any` |
...
| -8 | `zuzu/packages/company/meeting/registration_fee/types.py:98` | `number_of_shareholders_meeting_minutes_notarization` | constant | 11 | 19 | `` |
| -8 | `zuzu/packages/company/meeting/registration_fee/types.py:99` | `number_of_directors_meeting_minutes_notarization` | constant | 11 | 19 | `` |
| -8 | `zuzu/packages/ms_word/services/utils/types.py:29` | `font` | constant | 17 | 25 | `_DocxRunFont` |
| -7 | `zuzu/packages/company/meeting/services/registration_form_director_change_service.py:22` | `item_types` | constant | 15 | 22 | `` |
...
| -5 | `zuzu/packages/investment_association/bulk_email/types.py:19` | `email` | constant | 1 | 6 | `` |
...
| -4 | `zuzu/packages/krx/types.py:28` | `price` | constant | 0 | 4 | `` |
...
| -3 | `zuzu/packages/stock/stock_service.py:55` | `new_stocks` | constant | 9 | 12 | `` |
