...
- Exact: **2404/25638 = 9.38%**
- Overcount: **23233**
- Usage changed from previous report: **2876**
- Annotation base check without structural margin: exact **2596/7687 = 33.77%**, under **108**, missed **11**, over **4972**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9621 | 37.53% |
| inlay_over_no_lsp_refs | 6263 | 24.43% |
| inlay_over_by_50plus | 5224 | 20.38% |
| exact | 2404 | 9.38% |
| inlay_over_by_1-5 | 2125 | 8.29% |
| inlay_under | 1 | 0.00% |
...
|---:|---|---|---|---:|---:|---:|
| -1 | `zuzu/common/factory/base.py:132` | `fake` | function | 5 | 6 | 669 |

## Top Over Counts

| diff | file:line | name | kind | usage | lsp | previous |
|---:|---|---|---|---:|---:|---:|
| 1423 | `zuzu/common/management/commands/bq_schema_reference/model_registry.py:126` | `models` | constant | 1428 | 5 | 49 |
...
| 211 | `zuzu/db/models/subscription/subscription_plan.py:64` | `Name` | class | 343 | 132 | 346 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-pyi-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-pyi-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-pyi-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-pyi-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-pyi-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **41.85**
