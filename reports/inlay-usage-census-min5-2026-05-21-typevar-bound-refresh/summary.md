...
- Graph: rebuilt after generic TypeVar-bound receiver substitution; verified by `graph-symbol-query` JSON join, not MCP graph
...
- Overcount: **23808**
- Usage changed from previous report: **995**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-21-typevar-bound-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-21-typevar-bound-refresh/discrepancies.jsonl`
