...
- Graph: rebuilt after TypeVar-bound, TypedDict subscript-key, and Unpack[TypedDict] binding changes; verified by `graph-symbol-query` JSON join, not MCP graph
...
- Overcount: **23807**
- Usage changed from previous report: **1324**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9155 | 35.65% |
| inlay_over_no_lsp_refs | 6622 | 25.79% |
| inlay_over_by_50plus | 6007 | 23.39% |
| inlay_over_by_1-5 | 2023 | 7.88% |
| exact | 1871 | 7.29% |
...
| 330 | `zuzu/packages/incorporation/services/incorporation_service.py:570` | `director_type` | function | 331 | 1 | 556 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-21-unpack-typeddict-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-21-unpack-typeddict-refresh/discrepancies.jsonl`
