...
- Graph: import-alias-prune-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2372/25640 = 9.25%**
- Overcount: **23266**
- Usage changed from previous report: **4178**
...
| function | 1149 | 304 | 2 | 0 | 843 | 26.46% |
...
| inlay_under_by_1-5 | 2 | 0.01% |

## Top Under Counts

| diff | file:line | name | kind | usage | lsp | previous |
|---:|---|---|---|---:|---:|---:|
| -1 | `zuzu/packages/user/services/user_authentication_service.py:215` | `login` | function | 8 | 9 | 11 |
| -1 | `zuzu/packages/user/services/user_authentication_service.py:287` | `logout` | function | 12 | 13 | 17 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-import-alias-prune-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-import-alias-prune-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-import-alias-prune-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-import-alias-prune-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-import-alias-prune-refresh/annotation_base_under_patterns.md`
