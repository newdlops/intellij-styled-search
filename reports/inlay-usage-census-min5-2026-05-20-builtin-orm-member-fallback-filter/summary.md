...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 0.0 | 0.0 | 0.0 | 46.93 | 51.32 | 4.39 |
| class | 4903 | 0.0 | 0.0 | 0.0 | 24.76 | 42.76 | 18.00 |
| method | 2823 | 0.0 | 0.0 | 0.1 | 26.94 | 33.99 | 7.18 |
...
| inlay_over_by_50plus | 2198 | 8.6% |
| inlay_over_by_1-5 | 981 | 3.8% |
| match | 6 | 0.0% |
...
| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -183 | `zuzu/common/models/protocol.py:13` | `annotate` | method | 14 | 197 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-builtin-orm-member-fallback-filter/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-builtin-orm-member-fallback-filter/discrepancies.jsonl`
