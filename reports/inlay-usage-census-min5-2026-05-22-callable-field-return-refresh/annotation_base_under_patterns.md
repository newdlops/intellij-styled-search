...
- Base undercount if removing structural margin: 151
...
| `IaConsentFormOrMeetingEsigRequiredDocumentPageRangeManager` | 1 |

## Largest Base Unders

| diff | file:line | qualified | base | lsp | container extends | field extends |
|---:|---|---|---:|---:|---|---|
| -38 | `zuzu/packages/ms_word/services/utils/types.py:62` | `DocxParagraph.paragraph_format` | 61 | 99 | `Protocol` | `Format` |
| -37 | `zuzu/packages/ms_word/services/utils/types.py:68` | `DocxTableCell.paragraphs` | 15 | 52 | `Protocol` | `DocxParagraph` |
...
| -20 | `zuzu/packages/ms_word/services/utils/types.py:60` | `DocxParagraph.add_run` | 44 | 64 | `Protocol` | `Callable, DocxRun` |
...
| -13 | `zuzu/packages/ms_word/services/utils/types.py:56` | `DocxParagraph.runs` | 9 | 22 | `Protocol` | `DocxRun` |
...
| -8 | `zuzu/packages/ms_word/services/utils/types.py:29` | `DocxRun.font` | 17 | 25 | `Protocol` | `_DocxRunFont` |
| -8 | `zuzu/packages/ms_word/services/utils/types.py:73` | `DocxTableCell.add_paragraph` | 10 | 18 | `Protocol` | `Callable, DocxParagraph` |
| -8 | `zuzu/packages/ms_word/services/utils/types.py:84` | `DocxTableRow.cells` | 23 | 31 | `Protocol` | `DocxTableCell` |
...
| -7 | `zuzu/packages/ms_word/services/utils/types.py:21` | `_DocxRunFont.size` | 11 | 18 | `<none>` | `Length` |
| -7 | `zuzu/packages/ms_word/services/utils/types.py:85` | `DocxTableRow.height` | 3 | 10 | `Protocol` | `<none>` |
...
| -6 | `zuzu/packages/ms_word/services/utils/types.py:28` | `DocxRun.bold` | 7 | 13 | `Protocol` | `<none>` |
...
| -4 | `zuzu/packages/ms_word/services/utils/types.py:57` | `DocxParagraph.alignment` | 35 | 39 | `Protocol` | `<none>` |
...
| -3 | `zuzu/packages/company/company_investment_contract_info/graphql/mutations/base_authorized_options_soft_limit_mutation.py:37` | `TypedBaseAuthorizedOptionsSoftLimitMutationErrors.authorized_options_fixed_value` | 0 | 3 | `TypedValidationErrors` | `PositiveDecimal` |
| -3 | `zuzu/packages/company/company_investment_contract_info/graphql/mutations/base_authorized_options_soft_limit_mutation.py:38` | `TypedBaseAuthorizedOptionsSoftLimitMutationErrors.authorized_options_soft_limit_detailed_clause` | 0 | 3 | `TypedValidationErrors` | `<none>` |
| -3 | `zuzu/packages/company/company_investment_contract_info/graphql/mutations/delete_authorized_options_soft_limit_mutation.py:26` | `DeleteAuthorizedOptionsSoftLimitErrors.company_investment_contract_info` | 0 | 3 | `TypedValidationErrors` | `CompanyInvestmentContractInfo` |
| -3 | `zuzu/packages/corporate_registration/auto_updater/types/branch_change.py:11` | `BranchChangeEvent.address` | 29 | 32 | `<none>` | `<none>` |
| -3 | `zuzu/packages/investment_association/bulk_email/types.py:19` | `IaEmailRecipient.email` | 3 | 6 | `<none>` | `<none>` |
| -3 | `zuzu/packages/investment_simulation/services/types.py:58` | `InvestmentSimulationRoundInput.investors` | 15 | 18 | `InvestmentSimulationRoundInterface` | `InvestmentSimulationRoundInvestorInput` |
