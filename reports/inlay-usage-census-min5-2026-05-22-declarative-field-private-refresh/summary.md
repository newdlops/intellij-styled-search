...
- Graph: declarative-field-private-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2054/25640 = 8.01%**
- Overcount: **23586**
- Usage changed from previous report: **3285**
...
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 697 | 0 | 0 | 16085 | 4.15% |
...
| inlay_over_by_50plus | 5262 | 20.52% |
| inlay_over_by_1-5 | 2171 | 8.47% |
| exact | 2054 | 8.01% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-private-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-private-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-private-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-private-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-private-refresh/annotation_base_under_patterns.md`
