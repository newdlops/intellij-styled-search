...
- Exact: **2400/25638 = 9.36%**
- Overcount: **23236**
- Usage changed from previous report: **11011**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 13553 | 52.86% |
| inlay_over_no_lsp_refs | 6274 | 24.47% |
| exact | 2400 | 9.36% |
| inlay_over_by_1-5 | 2128 | 8.30% |
| inlay_over_by_50plus | 1281 | 5.00% |
| inlay_under | 2 | 0.01% |
...
|---:|---|---|---|---:|---:|---:|
| -1 | `zuzu/common/factory/agenda_new_issue_item_factory.py:65` | `AgendaNewIssueItemFactory` | class | 29 | 30 | 30 |
| -1 | `zuzu/db/models/venture_capital/portfolio_company_manager.py:49` | `PortfolioCompanyManager` | class | 33 | 34 | 34 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-class-margin21-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-class-margin21-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-class-margin21-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-class-margin21-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-class-margin21-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **32.01**
