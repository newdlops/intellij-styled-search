...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 13511 | 52.70% |
...
| -1 | `zuzu/db/models/meeting/meeting.py:919` | `RegistrationStatus` | class | 34 | 35 | 67 |
| -1 | `zuzu/db/models/modusign/modusign_document_action_history.py:119` | `Status` | class | 117 | 118 | 137 |
| -1 | `zuzu/packages/document/base.py:51` | `NextAction` | class | 54 | 55 | 82 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-overlap-tail-reference-filter-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-overlap-tail-reference-filter-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-overlap-tail-reference-filter-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-overlap-tail-reference-filter-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-overlap-tail-reference-filter-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **32.05**
