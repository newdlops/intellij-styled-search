...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 0.0 | 0.0 | 0.0 | 47.06 | 51.45 | 4.39 |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 15772 | 61.4% |
| inlay_over_no_lsp_refs | 6727 | 26.2% |
| inlay_over_by_50plus | 2222 | 8.6% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-member-receiver-continued-arg-filter/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-member-receiver-continued-arg-filter/discrepancies.jsonl`
