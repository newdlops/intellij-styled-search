...
- Current graph usage refresh: changed=166, missing=0, errors=0
- Graph usage changed from cached baseline: 8001/10000

## Usage Signal

- Exact match: **6084/10000 = 60.8%**
- Within +/-1: 70.9%
- Within +/-5: 82.6%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| method | 4000 | 59.2 | 68.7 | 84.0 | 9.88 | 12.65 | 2.77 |
| class | 2000 | 75.8 | 92.6 | 98.0 | 0.87 | 6.96 | 6.10 |
| function | 2000 | 91.8 | 96.2 | 98.0 | 0.84 | 4.56 | 3.71 |
| constant | 2000 | 18.3 | 28.4 | 48.9 | 24.01 | 26.32 | 2.31 |
...
|---|---:|---:|
| match | 6084 | 60.8% |
| inlay_over_no_lsp_refs | 1672 | 16.7% |
| inlay_over_by_1-5 | 1270 | 12.7% |
| inlay_over_by_6-50 | 738 | 7.4% |
...
| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -3 | `zuzu/db/models/shareholders_meeting.py:387` | `ceos_to_sign_for_notarization` | method | 5 | 8 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-under0-orm-receiver/discrepancies.jsonl`
