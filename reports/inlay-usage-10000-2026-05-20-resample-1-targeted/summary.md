...
- Current graph usage refresh: changed=6271, missing=0, errors=0
- Graph usage changed from cached baseline: 8000/10000

## Usage Signal

- Exact match: **4671/10000 = 46.7%**
- Within +/-1: 56.9%
- Within +/-5: 69.6%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| method | 4000 | 28.0 | 34.9 | 50.4 | 18.81 | 21.57 | 2.77 |
...
|---|---:|---:|
| match | 4671 | 46.7% |
| inlay_over_no_lsp_refs | 2071 | 20.7% |
| inlay_over_by_1-5 | 1436 | 14.4% |
| inlay_over_by_6-50 | 1387 | 13.9% |
| inlay_over_by_50plus | 435 | 4.3% |
...
| +392 | `zuzu/db/models/purchase/service_fee/service_fee.py:90` | `items` | method | 395 | 3 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-targeted/discrepancies.jsonl`
