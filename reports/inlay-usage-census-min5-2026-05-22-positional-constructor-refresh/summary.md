...
- Source refreshed rows: `reports/inlay-usage-census-min5-2026-05-22-match-case-refresh/lsp_usage_results_refreshed.jsonl`
- Present rows: **25638**
...
- Overcount: **23246**
- Usage changed from previous report: **134**
- Annotation base check without structural margin: exact **2582/7687 = 33.59%**, under **111**, missed **11**, over **4983**
...
| 224 | `zuzu/packages/corporate_registration/auto_updater/types/director_event.py:28` | `director_type` | constant | 239 | 15 | 204 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-positional-constructor-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-positional-constructor-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-positional-constructor-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-positional-constructor-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-positional-constructor-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.28**
