...
- Exact: **2340/25638 = 9.13%**
- Overcount: **23297**
- Usage changed from previous report: **3203**
- Annotation base check without structural margin: exact **2537/7687 = 33.00%**, under **118**, missed **11**, over **5021**

## Per Kind

| kind | n | exact | under | missed | over | exact% |
|---|---:|---:|---:|---:|---:|---:|
| constant | 16780 | 975 | 1 | 0 | 15804 | 5.81% |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9538 | 37.20% |
| inlay_over_no_lsp_refs | 6328 | 24.68% |
| inlay_over_by_50plus | 5278 | 20.59% |
| exact | 2340 | 9.13% |
| inlay_over_by_1-5 | 2153 | 8.40% |
| inlay_under | 1 | 0.00% |
...
|---:|---|---|---|---:|---:|---:|
| -1 | `zuzu/packages/fi_sta/graphql/mutations/mixins/fi_sta_validation_mixin.py:52` | `email` | constant | 4 | 5 | 6 |
...
| 278 | `zuzu/db/models/meeting_document/base/meeting_document.py:100` | `shareholders_meeting` | constant | 326 | 48 | 368 |
...
| 220 | `zuzu/packages/corporate_registration/auto_updater/types/director_event.py:28` | `director_type` | constant | 235 | 15 | 204 |
...
| 204 | `zuzu/packages/option/tests/services/test_vesting_traceable_create_service_data.py:19` | `quantity` | constant | 212 | 8 | 199 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-line-scoped-assignment-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-line-scoped-assignment-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-line-scoped-assignment-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-line-scoped-assignment-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-line-scoped-assignment-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **42.87**
