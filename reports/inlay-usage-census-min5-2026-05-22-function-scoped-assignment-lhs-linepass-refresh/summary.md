...
- Graph: function-scoped-assignment-lhs-linepass-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 680 | 0 | 0 | 16102 | 4.05% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-linepass-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-linepass-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-linepass-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-linepass-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-linepass-refresh/annotation_base_under_patterns.md`
