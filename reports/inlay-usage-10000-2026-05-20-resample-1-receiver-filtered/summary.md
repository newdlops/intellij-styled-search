...
|---|---:|---:|---:|---:|---:|---:|---:|
| method | 4000 | 59.2 | 68.6 | 83.5 | 9.92 | 12.69 | 2.77 |
| class | 2000 | 75.8 | 92.6 | 98.0 | 0.87 | 6.96 | 6.10 |
| function | 2000 | 91.8 | 96.2 | 98.0 | 0.84 | 4.56 | 3.71 |
| constant | 2000 | 18.3 | 28.3 | 48.9 | 24.05 | 26.36 | 2.31 |
...
| inlay_over_by_1-5 | 1248 | 12.5% |
| inlay_over_by_6-50 | 758 | 7.6% |
| inlay_over_by_50plus | 236 | 2.4% |
...
| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -2 | `zuzu/db/models/stock.py:174` | `get_queryset` | method | 1 | 3 |
| -1 | `zuzu/db/models/faq/faq_link.py:21` | `get_queryset` | method | 0 | 1 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-receiver-filtered/discrepancies.jsonl`
