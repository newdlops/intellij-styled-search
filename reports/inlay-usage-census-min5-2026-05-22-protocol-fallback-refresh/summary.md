...
| inlay_over_by_50plus | 5223 | 20.37% |
| exact | 2394 | 9.34% |
...
|---:|---|---|---|---:|---:|---:|
| -147 | `zuzu/common/models/protocol.py:13` | `annotate` | method | 50 | 197 | 396 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-protocol-fallback-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-protocol-fallback-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-protocol-fallback-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-protocol-fallback-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-protocol-fallback-refresh/annotation_base_under_patterns.md`
