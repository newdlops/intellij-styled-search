...
- Graph: rebuilt after tuple/list unpack assignment element-type propagation; checked by `graph-symbol-query` JSON join
...
- Overcount: **23807**
- Usage changed from previous report: **2897**
- Annotation base check without structural margin: exact **2817/7685 = 36.66%**, under **161**, missed **41**, over **4707**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9172 | 35.72% |
| inlay_over_no_lsp_refs | 6622 | 25.79% |
| inlay_over_by_50plus | 5985 | 23.31% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-unpack-assignment-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-unpack-assignment-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-unpack-assignment-refresh/current_id_missing.jsonl`
