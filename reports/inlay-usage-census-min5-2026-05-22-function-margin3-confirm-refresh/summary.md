...
- Overcount: **23236**
- Usage changed from previous report: **10445**
- Annotation base check without structural margin: exact **3318/7687 = 43.16%**, under **150**, missed **3865**, over **354**
...
| function | 1149 | 304 | 1 | 0 | 844 | 26.46% |

## Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 13515 | 52.71% |
| inlay_over_no_lsp_refs | 6274 | 24.47% |
| exact | 2401 | 9.37% |
| inlay_over_by_1-5 | 2150 | 8.39% |
| inlay_over_by_50plus | 1297 | 5.06% |
| inlay_under | 1 | 0.00% |
...
|---:|---|---|---|---:|---:|---:|
| -1 | `zuzu/packages/investment_association/consent_form_or_meeting/electronic_signature/services/ia_esig_required_document_service.py:13` | `get_or_create_esig_required_document` | function | 6 | 7 | 7 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-function-margin3-confirm-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-function-margin3-confirm-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-function-margin3-confirm-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-function-margin3-confirm-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-function-margin3-confirm-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **32.39**
