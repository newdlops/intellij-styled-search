...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 13538 | 52.80% |
| inlay_over_no_lsp_refs | 6274 | 24.47% |
| exact | 2401 | 9.37% |
| inlay_over_by_1-5 | 2129 | 8.30% |
| inlay_over_by_50plus | 1296 | 5.05% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-protocol-terminal-orm-receiver-filter-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-protocol-terminal-orm-receiver-filter-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-protocol-terminal-orm-receiver-filter-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-protocol-terminal-orm-receiver-filter-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-protocol-terminal-orm-receiver-filter-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **32.40**
