...
- Current graph usage refresh: changed=25693, missing=0, errors=0
- Graph usage changed from cached baseline: 25695/25706

## Usage Signal

- Exact match: **1/25706 = 0.0%**
- Within +/-1: 0.0%
- Within +/-5: 0.0%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 0.0 | 0.0 | 0.0 | 129.16 | 133.55 | 4.39 |
| class | 4903 | 0.0 | 0.0 | 0.0 | 193.86 | 211.85 | 18.00 |
| method | 2823 | 0.0 | 0.0 | 0.1 | 28.33 | 35.50 | 7.18 |
| function | 1149 | 0.1 | 0.1 | 0.1 | 78.07 | 90.80 | 12.73 |

## Error Pattern Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_50plus | 16897 | 65.7% |
| inlay_over_no_lsp_refs | 6727 | 26.2% |
| inlay_over_by_6-50 | 2076 | 8.1% |
| inlay_over_by_1-5 | 5 | 0.0% |
| match | 1 | 0.0% |
...
| +1221 | `zuzu/app/pages.py:14` | `get_app_page_path` | function | 1221 | 0 |
...
| +601 | `zuzu/common/management/commands/bq_schema_reference/extractor.py:92` | `choices` | constant | 606 | 5 |
...
| +462 | `zuzu/packages/with_shareholder_role/decorators.py:34` | `stakeholder` | constant | 527 | 65 |
| +453 | `zuzu/common/factory/company_factory.py:25` | `establishment_date` | constant | 455 | 2 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-python-bare-fallback-gated-undercount-zero-v2/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-python-bare-fallback-gated-undercount-zero-v2/discrepancies.jsonl`
