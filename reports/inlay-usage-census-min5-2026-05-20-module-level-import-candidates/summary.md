...
- Current graph usage refresh: changed=25621, missing=0, errors=0
- Graph usage changed from cached baseline: 25682/25706

## Usage Signal

- Exact match: **5/25706 = 0.0%**
- Within +/-1: 0.0%
- Within +/-5: 3.8%
- Mean absolute error: 54.76
- Inlay mean: 62.42
- Pyright mean: 7.66
...
| class | 4903 | 0.0 | 0.0 | 0.0 | 98.89 | 116.89 | 18.00 |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 10750 | 41.8% |
| inlay_over_by_50plus | 7250 | 28.2% |
...
| +750 | `zuzu/common/models/big_number_field.py:6` | `BigNumberField` | class | 751 | 1 |
...
| +361 | `zuzu/db/models/company/bulk_email_template/company_bulk_email_template.py:53` | `Type` | class | 380 | 19 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-module-level-import-candidates/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-module-level-import-candidates/discrepancies.jsonl`
