...
- Exact likely/proxy match: **39863/158547 = 25.1%**
- MAY undercount risk: **0/158547 = 0.0%**
- Likely below proxy but MAY safe: **117411/158547 = 74.1%**
- Proxy overcount: **1273/158547 = 0.8%**
...
|---|---:|---:|---:|---:|---:|
| class | 10244 | 57.5 | 0.0 | 31.9 | 10.7 |
| field | 131054 | 23.2 | 0.0 | 76.7 | 0.1 |
| function | 4113 | 56.8 | 0.0 | 42.1 | 1.0 |
| method | 13136 | 9.7 | 0.0 | 90.2 | 0.1 |
...
| +84 | `zuzu/packages/modusign/services/modusign_client/apis/types/document.py:26` | `datetime` | field | 1784 | 1700 | 11705 | 1700 |
...
| +72 | `zuzu/db/models/company/payroll/payroll_ledger_item.py:24` | `ItemType` | class | 98 | 26 | 26 | 0 |
...
| +38 | `zuzu/db/models/company/payroll/payroll_ledger_item.py:39` | `DeductionType` | class | 42 | 4 | 4 | 0 |
...
| +31 | `zuzu/db/models/signup_log.py:12` | `Path` | class | 119 | 88 | 88 | 16 |
| +29 | `zuzu/db/models/company/payroll/payroll_ledger_item.py:35` | `SALARY` | field | 35 | 6 | 0 | 6 |

## Artifacts

- Population: `/private/tmp/inlay_usage_rg_census_min5_20260523_unique_name_language_scoped_rebuilt/population.jsonl`
- Discrepancies: `reports/inlay-usage-rg-census-min5-2026-05-23-unique-name-language-scoped-rebuilt/discrepancies.jsonl`
