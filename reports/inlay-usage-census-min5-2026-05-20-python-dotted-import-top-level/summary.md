...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 0.0 | 0.0 | 0.0 | 47.28 | 51.67 | 4.39 |
| class | 4903 | 0.0 | 0.0 | 0.0 | 24.76 | 42.76 | 18.00 |
| method | 2823 | 0.0 | 0.0 | 0.1 | 27.86 | 35.03 | 7.18 |
| function | 1149 | 0.3 | 0.3 | 85.5 | 9.30 | 22.03 | 12.73 |

## Error Pattern Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 15768 | 61.3% |
| inlay_over_no_lsp_refs | 6727 | 26.2% |
| inlay_over_by_50plus | 2226 | 8.7% |
| inlay_over_by_1-5 | 978 | 3.8% |
| match | 7 | 0.0% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-python-dotted-import-top-level/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-python-dotted-import-top-level/discrepancies.jsonl`
