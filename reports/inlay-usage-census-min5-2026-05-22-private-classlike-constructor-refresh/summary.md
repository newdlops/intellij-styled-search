...
- Graph: private-classlike-constructor-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23262**
- Usage changed from previous report: **6097**
- Annotation base check without structural margin: exact **3402/7696 = 44.20%**, under **120**, missed **26**, over **4148**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-private-classlike-constructor-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-private-classlike-constructor-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-private-classlike-constructor-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-private-classlike-constructor-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-private-classlike-constructor-refresh/annotation_base_under_patterns.md`
