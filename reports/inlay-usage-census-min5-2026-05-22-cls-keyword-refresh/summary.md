...
- Graph: cls-keyword-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23586**
- Usage changed from previous report: **3667**
- Annotation base check without structural margin: exact **2798/7688 = 36.39%**, under **126**, missed **32**, over **4732**
...
| inlay_over_by_50plus | 5263 | 20.53% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-cls-keyword-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-cls-keyword-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-cls-keyword-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-cls-keyword-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-cls-keyword-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **43.16**
