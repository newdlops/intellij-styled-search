...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-inherited-protocol-terminal-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-inherited-protocol-terminal-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-inherited-protocol-terminal-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-inherited-protocol-terminal-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-inherited-protocol-terminal-refresh/annotation_base_under_patterns.md`
