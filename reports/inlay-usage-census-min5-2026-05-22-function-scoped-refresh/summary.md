...
- Graph: function-scoped-local-symbol-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
- Source refreshed rows: `reports/inlay-usage-census-min5-2026-05-22-oneline-header-refresh/lsp_usage_results_refreshed.jsonl`
- Present rows: **25640**
- Semantic missing carried from source remap: **28**
- Current-id missing during refresh: **0**
- Dropped stale cached rows no longer present in the corrected graph: **14**
- Undercount: **0**
- Missed (usage=0, lsp>0): **0**
- Exact: **1857/25640 = 7.24%**
- Overcount: **23783**
- Usage changed from previous report: **261**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9094 | 35.47% |
| inlay_over_no_lsp_refs | 6621 | 25.82% |
| inlay_over_by_50plus | 5980 | 23.32% |
| inlay_over_by_1-5 | 2088 | 8.14% |
| exact | 1857 | 7.24% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **44.85**
