...
| -2 | `zuzu/db/models/stakeholder/esop_participant.py:101` | `employee_stock_set` | constant | 11 | 13 | `AllEmployeeStockManager` |
...
| -2 | `zuzu/packages/corporate_registration/xml_parser/types/xml_parser_capital.py:7` | `share_class` | constant | 0 | 2 | `` |
| -2 | `zuzu/packages/investment_association/helpdesk/graphql/mutations/base/ia_question_thread_message_validation_mutation.py:36` | `attachments` | constant | 1 | 3 | `QuestionMessageAttachmentQuerySet` |
