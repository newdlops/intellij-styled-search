...
- Current graph usage refresh: changed=16563, missing=0, errors=0

## Usage Signal

- Exact match: **2408/25706 = 9.4%**
- Missing: **0**
- Undercount: **23**
- Overcount: 23275
- Within +/-1: 11.8%
- Within +/-5: 20.6%
- Mean absolute error: 47.40
- Inlay mean: 55.05
- Pyright mean: 7.66
...
| constant | 16831 | 1.9 | 8 | 2.2 | 2.8 | 62.97 | 67.35 | 4.39 |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9323 | 36.3% |
| inlay_over_no_lsp_refs | 6710 | 26.1% |
| inlay_over_by_50plus | 4437 | 17.3% |
| inlay_over_by_1-5 | 2805 | 10.9% |
| match | 2408 | 9.4% |
...
| +1027 | `zuzu/cms/admin/content_author/content_author.py:11` | `model` | constant | 1027 | 0 | 8 |
...
| +610 | `zuzu/packages/question_thread/types/incorporation_request_list_filter_input_type.py:11` | `order_by` | constant | 610 | 0 | 253 |
| +610 | `zuzu/packages/question_thread/types/meeting_list_filter_input_type.py:15` | `order_by` | constant | 610 | 0 | 253 |
| +610 | `zuzu/packages/venture_capital/quarterly_report/types.py:184` | `order_by` | constant | 610 | 0 | 253 |
| +605 | `zuzu/packages/product/tests/services/test_product_conversion_service.py:21` | `now` | constant | 613 | 8 | 578 |
| +604 | `zuzu/common/factory/audit_log/company_owner_audit_log_factory.py:13` | `action_type` | constant | 604 | 0 | 39 |
...
- Refreshed valid results: `/Users/lky/project/intellij-styled-search/reports/inlay-usage-census-min5-2026-05-21-exact-receiver-only/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `/Users/lky/project/intellij-styled-search/reports/inlay-usage-census-min5-2026-05-21-exact-receiver-only/discrepancies.jsonl`
