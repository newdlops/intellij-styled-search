...
- Exact likely/proxy match: **39571/158547 = 25.0%**
- MAY undercount risk: **0/158547 = 0.0%**
- Likely below proxy but MAY safe: **116363/158547 = 73.4%**
- Proxy overcount: **2613/158547 = 1.6%**
...
| method | 13136 | 10.7 | 0.0 | 88.9 | 0.3 |
...
| +490 | `zuzu/packages/ms_word/services/utils/docx_replace_image.py:226` | `replace` | method | 743 | 253 | 26 | 253 |
...
| +154 | `zuzu/packages/modusign/services/modusign_client/apis/types/document.py:42` | `locale` | field | 154 | 0 | 19 | 0 |
| +152 | `zuzu/packages/hrm/emp/types.py:49` | `employeeNumber` | field | 152 | 0 | 0 | 0 |
| +144 | `zuzu/packages/corporate_registration/services/infotech_client.py:285` | `api` | field | 153 | 9 | 40 | 9 |
...
| +134 | `zuzu/common/types/env_collection.py:25` | `env` | method | 135 | 1 | 146 | 1 |
...
| +65 | `zuzu/packages/company/notifications/company_create_request_unfinished_slack_notification.py:44` | `diff` | field | 69 | 4 | 23 | 4 |
...
| +58 | `zuzu/packages/incorporation/tests/mutations/test_create_incorporated_company.py:94` | `establishmentDate` | field | 58 | 0 | 0 | 0 |
| +57 | `zuzu/packages/captable/excel_writers/shareholder_register_excel_writer.py:21` | `origin` | field | 127 | 70 | 0 | 70 |
| +54 | `zuzu/packages/document/base.py:51` | `NextAction` | class | 55 | 1 | 1 | 54 |
| +54 | `zuzu/packages/unlisted_stock_management/notification/edit_individual_investor_sales_intent_slack_notification.py:65` | `individual_investor` | method | 66 | 12 | 0 | 12 |
| +54 | `zuzu/db/models/hrm/document/form/hrm_document_form_field_definition.py:27` | `TEXT` | field | 54 | 0 | 0 | 0 |
| +54 | `zuzu/packages/company/payroll/year_end_tax_settlement/services/parsers/base.py:97` | `normalize` | method | 77 | 23 | 0 | 23 |
...
| +46 | `zuzu/tests/meeting/test_meeting_draft.py:94` | `isRegistrationAssistance` | field | 46 | 0 | 0 | 0 |

## Artifacts

- Population: `/private/tmp/inlay_usage_rg_census_min5_20260523_unique_name_likely_rebuilt/population.jsonl`
- Discrepancies: `reports/inlay-usage-rg-census-min5-2026-05-23-unique-name-likely-rebuilt/discrepancies.jsonl`
