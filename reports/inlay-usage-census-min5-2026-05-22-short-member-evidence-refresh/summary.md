...
- Graph: short-member-receiver-evidence-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Undercount: **1**
- Missed (usage=0, lsp>0): **1**
- Exact: **2084/25640 = 8.13%**
- Overcount: **23555**
- Usage changed from previous report: **1685**
...
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 723 | 1 | 1 | 16058 | 4.31% |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9234 | 36.01% |
| inlay_over_no_lsp_refs | 6580 | 25.66% |
| inlay_over_by_50plus | 5570 | 21.72% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-short-member-evidence-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-short-member-evidence-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-short-member-evidence-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-short-member-evidence-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-short-member-evidence-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **43.12**
