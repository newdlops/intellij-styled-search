...
- Exact: **2410/25638 = 9.40%**
- Overcount: **23228**
- Usage changed from previous report: **12102**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 13581 | 52.97% |
| inlay_over_no_lsp_refs | 6274 | 24.47% |
| exact | 2410 | 9.40% |
| inlay_over_by_1-5 | 2135 | 8.33% |
| inlay_over_by_50plus | 1238 | 4.83% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-method-margin10-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-method-margin10-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-method-margin10-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-method-margin10-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-method-margin10-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **31.84**
