...
- Current graph usage refresh: changed=2292, missing=0, errors=0
- Graph usage changed from cached baseline: 9331/25706
...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 7.0 | 9.9 | 26.7 | 26.52 | 30.86 | 4.39 |
| class | 4903 | 44.4 | 61.8 | 90.7 | 4.07 | 22.06 | 18.00 |
| method | 2823 | 21.8 | 27.8 | 48.5 | 16.85 | 23.98 | 7.18 |
| function | 1149 | 74.8 | 82.7 | 89.6 | 7.01 | 19.70 | 12.73 |

## Error Pattern Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 6896 | 26.8% |
| inlay_over_no_lsp_refs | 6713 | 26.1% |
| inlay_over_by_1-5 | 5575 | 21.7% |
| match | 4829 | 18.8% |
| inlay_over_by_50plus | 1580 | 6.1% |
| inlay_under_by_1-5 | 95 | 0.4% |
| inlay_under_by_6-50 | 15 | 0.1% |
| inlay_missed | 3 | 0.0% |
...
| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -41 | `zuzu/db/models/stakeholder/stakeholder.py:59` | `registration_number` | constant | 122 | 163 |
| -41 | `zuzu/db/models/stakeholder/stakeholder.py:246` | `registration_number` | constant | 122 | 163 |
| -41 | `zuzu/db/models/stakeholder/stakeholder.py:265` | `registration_number` | constant | 122 | 163 |
...
| -8 | `zuzu/db/models/hrm/emp/hrm_emp.py:549` | `email` | constant | 11 | 19 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-class-receiver-context-existing-sample/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-class-receiver-context-existing-sample/discrepancies.jsonl`
