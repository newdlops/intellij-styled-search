...
- Graph: short-member-exception-code-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Overcount: **23582**
- Usage changed from previous report: **1650**
- Annotation base check without structural margin: exact **2916/7688 = 37.93%**, under **125**, missed **33**, over **4614**
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9231 | 36.00% |
| inlay_over_no_lsp_refs | 6606 | 25.76% |
| inlay_over_by_50plus | 5574 | 21.74% |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-short-member-exception-code-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-short-member-exception-code-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-short-member-exception-code-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-short-member-exception-code-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-short-member-exception-code-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **43.17**
