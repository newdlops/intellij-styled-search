...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-alias-usage-filter-orm-floor-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-alias-usage-filter-orm-floor-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-alias-usage-filter-orm-floor-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-alias-usage-filter-orm-floor-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-alias-usage-filter-orm-floor-refresh/annotation_base_under_patterns.md`
