...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 0.0 | 0.0 | 0.0 | 46.61 | 51.00 | 4.39 |
| class | 4903 | 0.0 | 0.0 | 0.0 | 24.76 | 42.76 | 18.00 |
| method | 2823 | 0.0 | 0.0 | 0.1 | 26.70 | 33.88 | 7.18 |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 15807 | 61.5% |
| inlay_over_no_lsp_refs | 6727 | 26.2% |
| inlay_over_by_50plus | 2186 | 8.5% |
...
| +238 | `zuzu/packages/company/meeting/actions/send_shareholders_meeting_convocation_notice_email_action.py:23` | `meeting` | method | 239 | 1 |
| +236 | `zuzu/db/models/subscription/subscription_plan.py:64` | `Name` | class | 368 | 132 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-noisy-value-member-filter/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-noisy-value-member-filter/discrepancies.jsonl`
