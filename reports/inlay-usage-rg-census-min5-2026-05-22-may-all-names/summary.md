...
- Exact likely/proxy match: **28407/146827 = 19.3%**
- MAY undercount risk: **31/146827 = 0.0%**
- Likely below proxy but MAY safe: **117908/146827 = 80.3%**
- Proxy overcount: **481/146827 = 0.3%**
...
| field | 120487 | 18.8 | 0.0 | 81.2 | 0.0 |
| function | 4134 | 38.1 | 0.0 | 60.9 | 1.0 |
| method | 11962 | 3.7 | 0.0 | 96.3 | 0.0 |

## Top MAY Under Risk

| diff | file:line | name | kind | graph | proxy | bare | member |
|---:|---|---|---|---:|---:|---:|---:|
| -10 | `zuzu/packages/rsu/tests/services/test_adjust_rsu_vesting_traceable.py:119` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/rsu/tests/services/test_adjust_rsu_vesting_traceable.py:145` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/captable/excel_writers/tests/test_captable_excel_writer.py:519` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/option/tests/services/test_option_adjustment_service.py:129` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/event_time_machine/test/test_option_related_event_time_travel_test_case.py:145` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/db/models/option/tests/test_option_query_set.py:168` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/db/models/option/tests/test_option_query_set.py:186` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_mutation.py:56` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_mutation.py:71` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_mutation.py:79` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_mutation.py:109` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:63` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:79` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:88` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:136` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:145` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_edit_mutation.py:55` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/graphql/mutations/stock_consolidation_mutation.py:49` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/db/models/events/stock/stock_consolidation_event.py:38` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/common/factory/stock_consolidation_event_factory.py:12` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/stock_service.py:625` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/stock_service.py:658` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:352` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:380` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:393` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:406` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:413` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/stock/tests/test_stock_service.py:418` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/option/tests/services/test_vesting_traceable_adjust_service.py:168` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -10 | `zuzu/packages/option/tests/services/test_vesting_traceable_create_service.py:230` | `consolidation_ratio` | field | 0 | 10 | 27 | 10 |
| -8 | `zuzu/packages/stock/replayable/stock_consolidation_replayable.py:46` | `consolidation_ratio` | field | 2 | 10 | 27 | 10 |
...
- Population: `/private/tmp/inlay_usage_rg_census_min5_20260522_may_all_names/population.jsonl`
- Discrepancies: `reports/inlay-usage-rg-census-min5-2026-05-22-may-all-names/discrepancies.jsonl`
