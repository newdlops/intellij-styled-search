...
| function | 1149 | 0.0 | 0.0 | 0.0 | 41.38 | 54.11 | 12.73 |

## Error Pattern Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 11683 | 45.4% |
| inlay_over_by_50plus | 7288 | 28.4% |
...
| +377 | `zuzu/packages/incorporation/services/incorporation_service.py:570` | `director_type` | function | 378 | 1 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-20-relative-package-import-fix/lsp_usage_results_refreshed.jsonl`
- Source timeout quarantine: `/private/tmp/inlay_usage_census_min5_20260520_datepruned/lsp_usage_timeouts.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-relative-package-import-fix/discrepancies.jsonl`
