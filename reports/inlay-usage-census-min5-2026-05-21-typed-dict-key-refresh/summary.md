...
- Graph: rebuilt after TypeVar-bound and TypedDict subscript-key resolution; verified by `graph-symbol-query` JSON join, not MCP graph
...
- Overcount: **23807**
- Usage changed from previous report: **1299**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-21-typed-dict-key-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-21-typed-dict-key-refresh/discrepancies.jsonl`
