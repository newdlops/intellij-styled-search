...
- Graph: declarative-field-evidence-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2058/25640 = 8.03%**
- Overcount: **23581**
- Usage changed from previous report: **3265**
- Annotation base check without structural margin: exact **2914/7688 = 37.90%**, under **127**, missed **33**, over **4614**

## Per Kind

| kind | n | exact | under | missed | over | exact% |
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 697 | 1 | 0 | 16084 | 4.15% |
| class | 4900 | 965 | 0 | 0 | 3935 | 19.69% |
| method | 2809 | 95 | 0 | 0 | 2714 | 3.38% |
| function | 1149 | 301 | 0 | 0 | 848 | 26.20% |
...
| inlay_over_no_lsp_refs | 6606 | 25.76% |
...
|---:|---|---|---|---:|---:|---:|
| -7 | `zuzu/db/models/question_thread/question_thread.py:481` | `_display_date` | constant | 2 | 9 | 10 |
...
| 244 | `zuzu/db/models/meeting_document/base/meeting_document.py:100` | `shareholders_meeting` | constant | 292 | 48 | 368 |
| 239 | `zuzu/packages/company/meeting/services/meeting_execution_service/__init__.py:227` | `meeting` | constant | 270 | 31 | 278 |
| 228 | `zuzu/app/services/stock_factory_service.py:22` | `registration_number` | constant | 242 | 14 | 136 |
...
| 203 | `zuzu/packages/company/stakeholder/director/types/director_compensation_type.py:71` | `director_type` | constant | 204 | 1 | 217 |

## Artifacts

- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-evidence-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-evidence-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-evidence-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-evidence-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-declarative-field-evidence-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **43.13**
