...
- Graph: typed-dict-string-subscript-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Dropped stale cached rows no longer present in the corrected graph: **2**
- Undercount: **0**
- Missed (usage=0, lsp>0): **0**
- Exact: **2376/25638 = 9.27%**
- Overcount: **23262**
- Usage changed from previous report: **6341**
- Annotation base check without structural margin: exact **3075/7696 = 39.96%**, under **121**, missed **23**, over **4477**
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-typed-dict-string-subscript-refresh/annotation_base_under_patterns.md`
