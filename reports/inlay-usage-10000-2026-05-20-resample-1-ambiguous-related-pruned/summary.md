...
- Current graph usage refresh: changed=366, missing=0, errors=0
- Graph usage changed from cached baseline: 8001/10000

## Usage Signal

- Exact match: **6156/10000 = 61.6%**
- Within +/-1: 71.4%
- Within +/-5: 82.8%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| method | 4000 | 60.9 | 69.9 | 84.5 | 9.56 | 12.32 | 2.77 |
| class | 2000 | 75.8 | 92.6 | 98.0 | 0.87 | 6.96 | 6.10 |
| function | 2000 | 91.8 | 96.2 | 98.0 | 0.84 | 4.56 | 3.71 |
| constant | 2000 | 18.4 | 28.2 | 48.7 | 24.24 | 26.55 | 2.31 |
...
|---|---:|---:|
| match | 6156 | 61.6% |
| inlay_over_no_lsp_refs | 1644 | 16.4% |
| inlay_over_by_1-5 | 1237 | 12.4% |
| inlay_over_by_6-50 | 725 | 7.2% |
| inlay_over_by_50plus | 227 | 2.3% |
| inlay_under_by_1-5 | 9 | 0.1% |
| inlay_missed | 2 | 0.0% |
...
| -2 | `zuzu/db/models/hrm/attendance/work/hrm_staggered_work_schedule.py:119` | `get_queryset` | method | 4 | 6 |
| -2 | `zuzu/db/models/company_managing_entity/bulk_email/cme_bulk_email_template.py:30` | `get_queryset` | method | 0 | 2 |
| -2 | `zuzu/db/models/company/investment_simulation/investment_simulation_purchase_investment.py:53` | `get_queryset` | method | 1 | 3 |
...
| -2 | `zuzu/db/models/stakeholder/stakeholder.py:115` | `email` | method | 59 | 61 |
| -1 | `zuzu/db/models/stakeholder/employee/employment_status.py:53` | `get_queryset` | method | 18 | 19 |
| -1 | `zuzu/db/models/company/payroll/year_end_tax_settlement/yets_employee.py:291` | `get_queryset` | method | 5 | 6 |
| -1 | `zuzu/db/models/agenda/option_grant/agenda_option_grant_grantee.py:43` | `get_queryset` | method | 4 | 5 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-ambiguous-related-pruned/discrepancies.jsonl`
