...
- Current graph usage refresh: changed=5273, missing=0, errors=0
- Graph usage changed from cached baseline: 8220/25706

## Usage Signal

- Exact match: **4822/25706 = 18.8%**
- Within +/-1: 24.9%
- Within +/-5: 44.1%
...
|---|---:|---:|---:|---:|---:|---:|---:|
| constant | 16831 | 7.0 | 9.9 | 26.9 | 26.71 | 31.06 | 4.39 |
| class | 4903 | 44.4 | 61.8 | 90.7 | 4.07 | 22.06 | 18.00 |
| method | 2823 | 21.3 | 26.8 | 47.6 | 17.50 | 24.56 | 7.18 |
| function | 1149 | 74.8 | 82.6 | 89.6 | 7.02 | 19.71 | 12.73 |

## Error Pattern Distribution

| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 6851 | 26.7% |
| inlay_over_no_lsp_refs | 6714 | 26.1% |
| inlay_over_by_1-5 | 5597 | 21.8% |
| match | 4822 | 18.8% |
| inlay_over_by_50plus | 1594 | 6.2% |
| inlay_under_by_1-5 | 103 | 0.4% |
| inlay_under_by_6-50 | 22 | 0.1% |
| inlay_missed | 3 | 0.0% |
...
| +464 | `zuzu/common/models/protocol.py:11` | `exists` | method | 464 | 0 |

## Top Under Counts

| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -32 | `zuzu/db/models/option/option_vesting/option_vesting_traceable.py:338` | `get_queryset` | method | 69 | 101 |
...
| -28 | `zuzu/db/models/stakeholder/stakeholder.py:59` | `registration_number` | constant | 135 | 163 |
| -28 | `zuzu/db/models/stakeholder/stakeholder.py:246` | `registration_number` | constant | 135 | 163 |
| -28 | `zuzu/db/models/stakeholder/stakeholder.py:265` | `registration_number` | constant | 135 | 163 |
...
| -9 | `zuzu/db/models/question_thread/company_question_thread.py:383` | `message_set` | constant | 31 | 40 |
...
| -8 | `zuzu/db/models/option/option.py:96` | `grantee` | constant | 77 | 85 |
...
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-20-return-collection-flow-no-hardcode/discrepancies.jsonl`
