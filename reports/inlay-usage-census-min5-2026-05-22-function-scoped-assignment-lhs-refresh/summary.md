...
- Graph: function-scoped-assignment-lhs-refresh; checked by `graph-symbol-query` JSON join and source-file `rg` spot checks
...
- Exact: **2036/25640 = 7.94%**
- Overcount: **23601**
- Usage changed from previous report: **846**
...
|---|---:|---:|---:|---:|---:|---:|
| constant | 16782 | 677 | 3 | 0 | 16102 | 4.03% |
...
| tag | n | percent |
|---|---:|---:|
| inlay_over_by_6-50 | 9026 | 35.20% |
| inlay_over_no_lsp_refs | 6622 | 25.83% |
| inlay_over_by_50plus | 5783 | 22.55% |
...
|---:|---|---|---|---:|---:|---:|
| -5 | `zuzu/packages/captable/excel_writers/statement_on_a_change_of_shares_excel_writer.py:319` | `data` | constant | 8 | 13 | 53 |
...
- Refreshed valid results: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-refresh/lsp_usage_results_refreshed.jsonl`
- Discrepancies: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-refresh/discrepancies.jsonl`
- Current-id missing: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-refresh/current_id_missing.jsonl`
- Stale cached rows: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-refresh/stale_cached_rows.jsonl`
- Annotation base-under patterns: `reports/inlay-usage-census-min5-2026-05-22-function-scoped-assignment-lhs-refresh/annotation_base_under_patterns.md`
- Mean absolute diff: **44.09**
