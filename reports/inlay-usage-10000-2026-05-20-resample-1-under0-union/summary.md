...
- Current graph usage refresh: changed=112, missing=0, errors=0
- Graph usage changed from cached baseline: 8001/10000

## Usage Signal

- Exact match: **6088/10000 = 60.9%**
- Within +/-1: 71.0%
- Within +/-5: 82.6%
...
| diff | file:line | name | kind | inlay | pyright |
|---:|---|---|---|---:|---:|
| -1 | `zuzu/db/models/agenda/base/directors_or_shareholders_meeting_agenda_child_base.py:24` | `shareholders_meeting_resolution_type` | method | 0 | 1 |
...
- Discrepancies: `reports/inlay-usage-10000-2026-05-20-resample-1-under0-union/discrepancies.jsonl`
